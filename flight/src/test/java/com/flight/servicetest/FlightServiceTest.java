...
//		flight2.setSeatNo("12 A");
		...
		when(flightRepository.searchByLocation("Bangalore", "Delhi", null)).thenReturn(allFlights);
		List<Flight> myFlights = flightService.flightSearch("Bangalore", "Delhi", null);
		assertEquals(2, myFlights.size());
	}
